...
noteRouter.post("/transcribe", rateLimiter_middleware_1.transcribeLimiter, fileUpload_helper_1.default.single("audio"), note_controller_1.NoteController.transcribeAudio);
noteRouter.post("/summary/:id", rateLimiter_middleware_1.summaryLimiter, note_controller_1.NoteController.generateSummary);
